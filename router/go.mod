...
require (
	collection.com/author v1.0.0
	collection.com/collection v1.0.0
	collection.com/country v1.0.0
	collection.com/item v1.0.0
	collection.com/language v1.0.0
	collection.com/publisher v1.0.0
	github.com/gin-contrib/cors v1.5.0
	github.com/gin-gonic/gin v1.9.1
)

require (
	collection.com/config v1.0.0 // indirect
